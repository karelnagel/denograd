...
import { cache_fn, string_to_bytes } from '../helpers.ts'
import { Compiled, Compiler, LRUAllocator, Program } from './allocator.ts'
...
const sel = cache_fn((name: string) => libobjc.symbols.sel_registerName(string_to_bytes(name)))
...
const REQUEST_TYPE_COMPILE = 13

const libobjc = Deno.dlopen('/usr/lib/libobjc.dylib', {
  objc_getClass: {
    result: 'objc_id',
  },
  sel_registerName: {
...
const libmetal = Deno.dlopen('/System/Library/Frameworks/Metal.framework/Metal', {
  MTLCodeGenServiceCreate: {
    result: 'objc_instance',
  },
})
const compiler = Deno.dlopen('/System/Library/PrivateFrameworks/MTLCompiler.framework/MTLCompiler', {
  MTLCodeGenServiceCreate: {
    result: 'ctypes.c_void_p',
  },
})
// // Must be loaded for default Metal Device: https://developer.apple.com/documentation/metal/1433401-mtlcreatesystemdefaultdevice?language=objc
Deno.dlopen('/System/Library/Frameworks/CoreGraphics.framework/CoreGraphics', {})
// libdispatch === part of libSystem on mac
const libdispatch = Deno.dlopen('/usr/lib/libSystem.dylib', {
...
// const msg = (ptr: objc_id, selector: string, args:any, restype: any) => {
...
// }
// const to_ns_str = (s: string) =>  msg(libobjc.symbols.objc_getClass("NSString"), "stringWithUTF8String:", s.encode(), restype=objc_instance)
...
export class MetalCompiler extends Compiler {
  //   const __init__ = () => {
...
export class MetalProgram extends Program {
