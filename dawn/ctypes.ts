...
> {
  ...
  loadFromPtr(ptr: Pointer<typeof this>, offset = 0): typeof this {
    if (ptr.value) {
      ...
      new Uint8Array(this.buffer, this.offset, this.byteLength).set(
  ...
  replaceWithPtr(ptr: Pointer<typeof this>, offset = 0): typeof this {
    if (ptr.value) {
      this.buffer = env.getArrayBuffer(ptr.native, this.byteLength, offset);
    }
    return this;
  }
  toString = () => {
...
export class U8 extends Type<number> {
  ...
  protected override _set = (val: number) =>
    new Uint8Array(this.buffer, this.offset).set([val]);
...
export class U16 extends Type<number> {
  ...
  protected override _value = () =>
    new Uint16Array(this.buffer, this.offset)[0];
  protected override _set = (val: number) =>
    new Uint16Array(this.buffer, this.offset).set([val]);
...
export class U32 extends Type<number> {
  ...
  protected override _value = () =>
    new Uint32Array(this.buffer, this.offset)[0];
  protected override _set = (val: number) =>
    new Uint32Array(this.buffer, this.offset).set([val]);
...
export class U64 extends Type<bigint> {
  ...
  protected override _value = () =>
    new BigUint64Array(this.buffer, this.offset)[0];
...
export class I8 extends Type<number> {
  ...
  protected override _set = (val: number) =>
    new Int8Array(this.buffer, this.offset).set([val]);
...
export class I16 extends Type<number> {
  ...
  protected override _set = (val: number) =>
    new Int16Array(this.buffer, this.offset).set([val]);
...
export class I32 extends Type<number> {
  ...
  protected override _set = (val: number) =>
    new Int32Array(this.buffer, this.offset).set([val]);
...
export class I64 extends Type<bigint> {
  ...
  protected override _value = () =>
    new BigInt64Array(this.buffer, this.offset)[0];
  protected override _set = (val: bigint) =>
    new BigInt64Array(this.buffer, this.offset).set([val]);
...
export class F32 extends Type<number> {
  ...
  protected override _value = () =>
    new Float32Array(this.buffer, this.offset)[0];
  protected override _set = (val: number) =>
    new Float32Array(this.buffer, this.offset).set([val]);
...
export class F64 extends Type<number> {
  ...
  protected override _value = () =>
    new Float64Array(this.buffer, this.offset)[0];
  protected override _set = (val: number) =>
    new Float64Array(this.buffer, this.offset).set([val]);
  static new = (val: number) => new F64().set(val);
}

// STRUCT
export class Struct<Value extends Record<string, Type<any>>>
  extends Type<
    ArrayBuffer,
    Value,
...
// POINTER
export class Pointer<_Value extends Type<any, any>>
  extends Type<Deno.PointerValue, bigint> {
  constructor(buffer?: ArrayBuffer, offset?: number) {
    super(buffer, offset, 8, 8);
  }
  ...
  protected override _setNative = (val: Deno.PointerValue) =>
    this.buffer = new BigUint64Array([env.ptrToU64(val)]).buffer;
...
// FUNCTION
export class Function<Args extends Type<any>[]>
  extends Type<
    Deno.PointerValue,
    bigint,
    Deno.PointerValue,
