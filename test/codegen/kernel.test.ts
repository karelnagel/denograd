          ...
          new UOp(Ops.SINK, dtypes.void, [
            new UOp(Ops.STORE, dtypes.void, [
              ...
              new UOp(
                ...
                [],
                new ShapeTracker([
                  new View([512, 1], [1, 0], 0, undefined, true),
                ]),
              ),
              new UOp(Ops.REDUCE_AXIS, dtypes.float, [
                new UOp(Ops.LOAD, dtypes.float, [
                  ...
                  new UOp(
                    ...
                    [],
                    new ShapeTracker([
                      new View([512, 10], [10, 1], 0, undefined, true),
                    ]),
                  ),
                ], undefined),
              ], [Ops.MAX, [1]]),
              ...
              new UOp(Ops.WHERE, dtypes.float, [
                new UOp(Ops.VALID, dtypes.bool, [
                  new UOp(
                    ...
                    [],
                    new ShapeTracker([
                      new View([32], [0], 0, undefined, false),
                    ]),
                  ),
                ], undefined),
              ...
              new UOp(Ops.WHERE, dtypes.float, [
                new UOp(Ops.VALID, dtypes.bool, [
                  new UOp(
                    ...
                    [],
                    new ShapeTracker([
                      new View([64], [0], 0, undefined, false),
                    ]),
                  ),
                ], undefined),
                new UOp(Ops.CONST, dtypes.float, [], 0.1),
...
const kernels = () =>
  kernelInputs().map(([opts, ast]) => [new Kernel(ast, opts)] as [Kernel]);
describe(
  "Kernel.init",
  compare(
    ...
    [
      ...
      [
        new UOp(
          ...
          dtypes.void,
          [],
          new ShapeTracker([new View([16], [1], 0, undefined, true)]),
        ),
        new ShapeTracker([new View([16], [1], 0, undefined, true)]),
        new Map<UOp, ShapeTracker>([]),
      ],
