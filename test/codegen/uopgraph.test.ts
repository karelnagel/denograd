...
Deno.test(
  ...
  compare(
    [
      ...
      [new UOp(Ops.SINK, dtypes.void, [new UOp(Ops.STORE, dtypes.void, [new UOp(Ops.INDEX, new PtrDType(11, 4, `float`, `f`, 1, undefined, dtypes.float, false, 1), [new UOp(Ops.DEFINE_GLOBAL, new PtrDType(11, 4, `float`, `f`, 1, undefined, dtypes.float, false, 1), [], 0), new UOp(Ops.ADD, dtypes.int, [new UOp(Ops.SPECIAL, dtypes.int, [], [`lidx0`, 2]), new UOp(Ops.MUL, dtypes.int, [new UOp(Ops.SPECIAL, dtypes.int, [], [`gidx0`, 5]), new UOp(Ops.CONST, dtypes.int, [], 2)], undefined)], undefined)], undefined), new UOp(Ops.CONST, dtypes.float, [], 0)], undefined)], new KernelInfo(1, 0, false)), new UOp(Ops.DEFINE_GLOBAL, new PtrDType(11, 4, `float`, `f`, 1, undefined, dtypes.float, false, 1), [], 0)],
