...
Deno.test(
  ...
  compare(
    [
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(5, 4, `int`, `i`, 1, undefined), Ops.CONST, 0, [], undefined, false],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(5, 4, `int`, `i`, 1, undefined), Ops.CONST, 1, [], undefined, false],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(5, 4, `int`, `i`, 1, undefined), Ops.CONST, -1, [], undefined, false],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(11, 4, `float`, `f`, 1, undefined), Ops.CONST, 0, [], undefined, false],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(11, 4, `float`, `f`, 1, undefined), Ops.CONST, 1, [], undefined, false],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(7, 8, `long`, `q`, 1, undefined), Ops.CONST, 0.0, [], undefined, false],
    ],
    create_lazybuffer,
...
Deno.test(
  ...
  compare(
    [
      [`PYTHON`, new ShapeTracker([new View([1], [0], 0, undefined, true)]), new DType(11, 4, `float`, `f`, 1, undefined), Ops.EMPTY, undefined, [], undefined, undefined],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(7, 8, `long`, `q`, 1, undefined), Ops.CONST, 0, [], undefined, new Metadata(`zeros`, ``, false)],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(5, 4, `int`, `i`, 1, undefined), Ops.CONST, 0, [], undefined, new Metadata(`randint`, ``, false)],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(11, 4, `float`, `f`, 1, undefined), Ops.CONST, 0.0, [], undefined, new Metadata(`zeros`, ``, false)],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(5, 4, `int`, `i`, 1, undefined), Ops.CONST, 1, [], undefined, new Metadata(`__getitem__`, ``, false)],
      [`CLANG`, new ShapeTracker([new View([], [], 0, undefined, true)]), new DType(5, 4, `int`, `i`, 1, undefined), Ops.CONST, 0, [], undefined, new Metadata(`__getitem__`, ``, false)],
    ],
...
Deno.test(
  ...
  compare(
    [
      [Ops.CONST, [], new DType(5, 4, `int`, `i`, 1, undefined), `CLANG`, 0, [], false],
      [Ops.CONST, [], new DType(5, 4, `int`, `i`, 1, undefined), `CLANG`, 1, [], false],
      [Ops.CONST, [], new DType(0, 1, `bool`, `?`, 1, undefined), `CLANG`, 1, [], false], // Fails, arg:1 vs arg:true
      [Ops.CONST, [], new DType(7, 8, `long`, `q`, 1, undefined), `CLANG`, 1, [], false],
      [Ops.CONST, [], new DType(7, 8, `long`, `q`, 1, undefined), `CLANG`, 2, [], false],
      [Ops.CONST, [], new DType(5, 4, `int`, `i`, 1, undefined), `CLANG`, -1, [], false],
    ],
    LazyBuffer.metaop,
