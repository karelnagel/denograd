import { Kernel } from "../../jsgrad/codegen/kernel.ts";
import { get_kernel, get_runner } from "../../jsgrad/engine/realize.ts";
import type { UOp } from "../../jsgrad/ops.ts";
...
describe(
  ...
  compare(
    kernelInputs,
    async (renderer, ast) =>
      (await get_kernel(renderer, ast)).get_optimized_ast(),
    [
