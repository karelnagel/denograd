import { init_whisper, LANGUAGES, MODELS, transcribe_file, type WhisperModel } from '../denograd/mod.ts'
...
const args = parseArgs({
  ...
  language: z.enum(Object.keys(LANGUAGES)).optional().describe('Language, only works with multilingual models'),
})
